...
const ar: TemplateMap = {
    ...
    matchFavoriteBody: '{home} ضد {away} — أهداف وأحداث مهمة، لاقيها في المفضلة',
    followedClubTitle: '🔔 تمت الإضافة للمفضلة',
    followedClubBody:
      'تم متابعة "{name}" وإضافته لتبويب المفضلة مع تفعيل إشعارات الفريق.',
    followedNationalTeamTitle: '🔔 تمت الإضافة للمفضلة',
    followedNationalTeamBody:
      'تم متابعة "{name}" وإضافته لتبويب المفضلة مع تفعيل إشعارات المنتخب.',
