          ...
          <View style={s.inner}>
            ...
            <View style={s.iconWrap}>
              <View style={s.iconShadow}>
                <Award size={32} color="#d8b4fe" />
              </View>
            </View>

            <Text style={s.title}>{t.xpInfo.title}</Text>

            <View style={s.row}>
              <View style={s.dot} />
              <Text style={s.text}>{t.xpInfo.rule1}</Text>
            </View>
            <View style={s.row}>
              <View style={s.dot} />
              <Text style={s.text}>{t.xpInfo.rule2}</Text>
            </View>
            <View style={s.row}>
              <View style={s.dot} />
              <Text style={s.text}>{t.xpInfo.rule3}</Text>
            </View>
            ...
            >
              ...
              <Text style={s.btnTxt}>{t.xpInfo.gotIt}</Text>
            </Pressable>
          </View>
        </View>
      </View>
