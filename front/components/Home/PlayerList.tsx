    ...
    <TouchableOpacity activeOpacity={0.8} onPress={onPress}>
        ...
        >
            <View style={{ alignItems: 'center', justifyContent: 'center', width: '100%', height: 100 }}>
                <View style={{ alignItems: 'center', justifyContent: 'center', width: 80, height: 80, borderRadius: 40, overflow: 'hidden', borderWidth: 2, borderColor: 'rgba(255,255,255,0.3)' }}>
                    {player.image && player.image.trim() !== '' && !imageError ? (
                        <ExpoImage
                        ...
                        <View style={{ width: '100%', height: '100%', borderRadius: 40, backgroundColor: 'rgba(255,255,255,0.1)', justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: 'rgba(255,255,255,0.2)' }}>
...
export const PlayerList = React.memo(({ players, onPlayerPress, onViewAllPress, isLoading = false }: PlayerListProps) => {
