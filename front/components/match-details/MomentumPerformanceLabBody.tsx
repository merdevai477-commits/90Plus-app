/**
 * Deferred Momentum lab UI — imports Skia.
 * Only require() this module after isSkiaNativeAvailable() is true.
 */
...
export default function MomentumPerformanceLabBody() {
