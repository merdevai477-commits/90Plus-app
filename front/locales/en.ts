...
export const en = {
  ...
  matchDetails: {
    ...
    highlightsTitle: 'Match information',
    highlightsAutoUpdate: 'Updates automatically with the first event',
    highlightsAutoUpdateHint: 'This tab switches to Events as soon as the first event appears.',
    topPlayersTitle: 'Top Players',
    topPlayersAttack: 'Attack',
    topPlayersMidfield: 'Midfield',
    topPlayersDefense: 'Defense',
    topPlayersGoals: 'Goals',
    topPlayersAssists: 'Assists',
    topPlayersRating: 'Rating',
    matchStaff: 'Officials',
  ...
  shareWin: {
    ...
    referralHintLead: 'A share counts only when you send it to ',
    referralHintXp: 'WhatsApp, Facebook or similar',
  ...
  chat: {
    ...
    thinking: {
      ...
      checkingLiveData: 'Checking 90Plus live data…',
      draftingPrecise: 'Writing a precise answer…',
    },
    navOpenPlayer: 'Player profile',
    navOpenClub: 'Club profile',
    navOpenMatch: 'Match details',
    navOpenMatches: "Today's matches",
    navMoreInfoHint: 'Want more details?',
    navGoPlayer: 'Open the player profile in 90Plus',
    navGoPlayerNamed: "Open {name}'s profile in 90Plus",
    navGoClub: 'Open the club profile in 90Plus',
    navGoClubNamed: "Open {name}'s profile in 90Plus",
    ...
    navVisitPlayer: 'Visit player profile',
    navVisitClub: 'Visit club profile',
