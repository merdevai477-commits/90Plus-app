...
export const en = {
  ...
  groups: {
    ...
    emptyBody: 'Create a group or join by invite code to start competing.',
    noMyGroupsYet: "You haven't joined any groups yet.",
    membersCountLabel: '{count} members',
    bestRank: 'Best Rank',
    myPoints: 'My Points',
    accuracyLabel: 'Accuracy',
    correctMatchesLabel: 'Correct Matches',
    groupStatsTitle: 'Group Stats',
    membersTitle: 'Members',
    rankingTitle: 'Ranking',
    roundNavLabel: 'Round',
    inviteFriend: 'Invite Friend',
    share: 'Share',
    copyInviteSuccess: 'Invite code copied.',
    shareGroupMessage: 'Join the group {group} directly from the app:',
    inviteFriendMessage: 'Join my 90Plus group, {name}:',
    searchFriendPlaceholder: 'Search for a user...',
    noFriendsToInvite: 'No friends available to invite right now.',
    noFriendsFound: 'No matching results found.',
    inviteButton: 'Invite',
    friendsLoadFailed: 'Could not load friends list.',
    groupCodeLabel: 'Group code',
    uploadImage: 'Upload image',
    groupNameLabel: 'Group name',
    groupNameExample: 'Example: Football Crew',
    createGroupHint: 'Start your group and compete',
    joinGroupHint: 'Enter invite code to join',
    predictionHome: 'Home win',
    predictionAway: 'Away win',
    predictionDraw: 'Draw',
    winnerPointsHint: 'Winner: 5 pts',
    precisePredictionHint: 'Exact score: 10 pts',
    noUpcomingMatches: 'No round matches available right now.',
    youLabel: 'You',
    groupOwner: 'Group Owner',
    groupMember: 'Member',
    kingCardTitle: '👑 King of Predictions Card',
    motivationFallback: 'Make your predictions to appear in the leaderboard.',
    leadingMessage: 'You are #1 in your group. Keep the lead.',
    rankGapMessage: 'You are rank {rank}, {points} points away from rank {nextRank}.',
    pointsLabel: '{points} points',
    noRankData: 'No ranking data yet for this tab.',
    roundTitle: 'Prediction Round',
    ...
    groupImagePlaceholder: 'Group image URL (optional)',
    inviteCodePlaceholder: 'Invite code (e.g. 90PLUS123)',
    groupCreated: 'Group created successfully.',
    groupJoined: 'Joined group successfully.',
    alreadyMember: 'You are already a member of this group.',
    invalidInviteCode: 'Invalid invite code.',
    groupActionFailed: 'Could not complete this action. Please try again.',
    changeImage: 'Change Image',
    tabs: {
      overall: 'Overall Ranking',
      weekly: 'This Week',
      best: 'Best Precise Pick',
      today: 'Most Points Today',
    },
  },
