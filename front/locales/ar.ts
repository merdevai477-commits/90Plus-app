...
export const ar = {
  ...
  matches: {
    ...
    screen: {
      ...
      weekDays: ['اثن', 'ثلا', 'أرب', 'خميس', 'جمعة', 'سبت', 'أحد'],
  ...
  predictAndWin: {
    ...
    wizard: {
      ...
      needValidTime24: 'أدخل وقتًا صحيحًا (00–23 و 00–59)',
  ...
  predictionGroupsInfo: {
    ...
    rule2: 'تعاونوا وتوقّعوا نتائج الجولات — فائز أو تعادل 2 XP، والنتيجة الدقيقة 5 XP.',
