...
const styles = StyleSheet.create({
  ...
  rowFeats: { flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', flexWrap: 'wrap', marginTop: 15 },
  featWrap: { flexDirection: 'row', alignItems: 'center' },
  sep: { width: 1, height: 36, backgroundColor: 'rgba(255,255,255,0.12)', marginHorizontal: 8 },
  feat: { alignItems: 'center', gap: 6, minWidth: 55 },
  featIcon: { width: 44, height: 44, borderRadius: 22, borderWidth: 1.5, borderColor: 'rgba(124,58,237,0.6)', alignItems: 'center', justifyContent: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.8, shadowRadius: 6, elevation: 8, overflow: 'hidden' },
  featLbl: { fontSize: 10, fontWeight: '800', color: '#FFFFFF', textAlign: 'center', lineHeight: 13 },
});
